        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_HistoryExams_AppUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AppUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptChoose = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "2f1e072d-60a1-4b1e-ad26-0a4859672c46", "User level", "user", "USER" },
                    { 1, "d963e8af-8426-4737-bfdb-12d088e54d20", "Administrator level", "admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 0, null, "79424c6d-5464-4b87-9add-a89fb262cc23", new DateTime(1999, 4, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "thtt260499@gmail.com", false, "User", "Default", false, null, "THTT260499@GMAIL.COM", "USER1999", "AQAAAAEAACcQAAAAEEd0og8XBSwHx8Ja13u/fEEq1l7Q0HiJErsptM2Ymgz//GgUfVqT2dJz/qTvEIs5SQ==", null, false, "", false, "user1999" },
                    { 1, 0, null, "922739c2-32fc-4b30-91cc-d53908849082", new DateTime(1999, 4, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "tamst09@gmail.com", false, "Admin", "Default", false, null, "tamst09@gmail.com", "admin1999", "AQAAAAEAACcQAAAAEOda4sxTfiV2hdCEMIuFoRiTUzjogPOCm64JaWeMizGuYYUeqRDgIjx7qn8xS5u7nA==", null, false, "", false, "admin1999" }
                });
